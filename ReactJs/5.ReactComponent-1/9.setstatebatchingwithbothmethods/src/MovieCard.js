...
class MovieCard extends Component
{
    ...
    addStars(){
        ...
        // When both methods of setState() are combined then last Method1 function will make all above calls(both method1 & method2) 
        // as single batch executed and if any method 2 setState() exists those will also be executed 
        ...
        this.setState({stars: this.state.stars+5});  // Last setState() using Method 1 and below setState() using Method 2 executed
        this.setState((prevState)=>{
            return {stars: prevState.stars+0.5};
        })
        this.setState((prevState)=>{
    ...
    decStars(){
        ...
        this.setState((prevState)=>{
            ...
            console.log("Synchoronous code in async Method 2 function:",this.state.stars);
