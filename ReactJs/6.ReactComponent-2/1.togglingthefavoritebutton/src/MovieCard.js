                ...
                <div className="movie-card">
                    ...
                    <div className="right">
                        ...
                        <div className="footer">
                            ...
                            <button onClick={this.toggleFav} className={fav? "unfavourite-btn" : "favourite-btn"}> {fav? "Unfavourite":"Favorite"}</button>
                            <button onClick={this.toggleCart} className="cart-btn">{carted?"Remove from cart":"Add to cart"}</button>
                        </div>
                    </div>
                </div>  
            </div>  
