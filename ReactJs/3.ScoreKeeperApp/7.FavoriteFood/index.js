/*Favorite Food
Send Feedback
Refactor the React app to use a common event handler function for the click event.


Create a new common function called handleFoodClick.
...
const food = {
  ...
  const App = () => (
    <div className="App">
      ...
      {typeof handleFoodClick === "function" && (<h2>Select your favourite food</h2>) }
